...
| Запуск | `$` → 2 с → `startlds$` (работает часами); `startldspl$` из прошивки робота даёт лишь короткий прогон мотора |
...
Веб-интерфейс `python/fm1828_gui.py`, живые данные с лидара FM1828 через мост на ESP32 (около 300 об/мин, 1430 точек на оборот):

*Полярный скан лидара FM1828, дальность 6 м:*

![Полярный скан лидара FM1828](docs/img/gui-scan.png)

*Карта занятости вокруг лидара FM1828 (белое — свободно, чёрное — препятствия, серое — неизвестно), ячейка 5 см:*

![Карта занятости по данным лидара FM1828](docs/img/gui-map.png)
