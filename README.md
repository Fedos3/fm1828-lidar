...
| Остановка | `stoplds$`; после неё новый старт возможен только после снятия питания (так делает и робот) |
...
- Точный таймаут, после которого остановленный лидар снова принимает старт без снятия питания (однократно наблюдалось ≈ 20 мин).
